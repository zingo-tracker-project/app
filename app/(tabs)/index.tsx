...
export default function HomeScreen() {
  ...
  const { webViewRef, setLoading, loading, showWebView, setShowWebView, handleNavigationStateChange, KAKAO_AUTH_URL, handleLogout, handleKakaoLogout, handleTokenRefresh, checkAccessTokenValidity } =
    useKakaoLogin(
      async (userData) => {
        ...
        <>
          {userInfo ? (
            <View style={{ alignItems: 'center' }}>
              ...
              <Button title="카카오 로그아웃" color="red" onPress={handleLogout} />
            </View>
          ) : (
